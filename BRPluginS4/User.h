...
#define CGItemDropRequest ((bool(*)(PMSG_ITEMTHROW * lpMsg, int aIndex, BOOL drop_type)) 0x0043F770)
#define gObjInventoryMoveItem ((byte(*)(int aIndex, BYTE source, BYTE target, int& durSsend, int& durTsend, BYTE sFlag, BYTE tFlag, LPBYTE siteminfo)) 0x0051EA00)
...
#define gObjSetBP ((void(*)(DWORD))0x00401F73)
#define GCReFillSend ((void(*)(int, WORD, BYTE, unsigned char, WORD))0x00404A20)
#define GCManaSend ((void(*)(DWORD, DWORD, DWORD, DWORD, DWORD))0x00402FBD)
#define PChatProc ((void(*)(PMSG_CHATDATA* lpChat, short aIndex)) 0x00439320)
#define ItemDurRepaire ((void(*)(LPOBJ lpObj, CItem * DurItem, int pos, int RequestPos)) 0x004473A0)
#define j_gObjUserDie ((void (*)(OBJECTSTRUCT*,OBJECTSTRUCT*))0x0050F7F0)
...
{										
	...
	/*<thisrel this+0x1c6c>*/ /*|0x1|*/ bool m_bMapSvrMoveQuit;
	/*<thisrel this+0x1c6d>*/ /*|0x1|*/ bool m_bMapSvrMoveReq;
	/*<thisrel this+0x1c70>*/ /*|0x4|*/ DWORD m_dwMapSvrQuitTick;
	/*<thisrel this+0x1c74>*/ /*|0x2|*/ short m_sPrevMapSvrCode;
	/*<thisrel this+0x1c76>*/ /*|0x2|*/ short m_sDestMapNumber;
	/*<thisrel this+0x1c78>*/ /*|0x1|*/ BYTE m_btDestX;
	/*<thisrel this+0x1c79>*/ /*|0x1|*/ BYTE m_btDestY; 
...
extern sPlayersStruct PlayersStruct[OBJECT_MAX];
